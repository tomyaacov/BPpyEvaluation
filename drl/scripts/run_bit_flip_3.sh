...
#SBATCH --job-name run_bit_flip_3 ### name of the job. replace my_job with your desired job name
#SBATCH --output run_bit_flip_3.out ### output log for running job - %J is the job number variable
...
~/.conda/envs/BPpyLiveness/bin/python bit_flipping.py 3 3 100000