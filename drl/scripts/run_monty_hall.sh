...
#SBATCH --job-name run_monty_hall ### name of the job. replace my_job with your desired job name
#SBATCH --output run_monty_hall.out ### output log for running job - %J is the job number variable
