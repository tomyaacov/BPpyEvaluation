...
#SBATCH --job-name run_monty_hall2 ### name of the job. replace my_job with your desired job name
#SBATCH --output run_monty_hall2.out ### output log for running job - %J is the job number variable
...
~/.conda/envs/BPpyLiveness/bin/python monty_hall.py