...
#SBATCH --job-name run_bit_flip_4 ### name of the job. replace my_job with your desired job name
#SBATCH --output run_bit_flip_4.out ### output log for running job - %J is the job number variable
