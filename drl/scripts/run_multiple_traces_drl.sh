...
#SBATCH --job-name run_multiple_traces_drl ### name of the job. replace my_job with your desired job name
#SBATCH --output run_multiple_traces_drl.out ### output log for running job - %J is the job number variable
...
~/.conda/envs/BPpyLiveness/bin/python pancake_multiple_traces_drl.py 200 25 100 run DQN
