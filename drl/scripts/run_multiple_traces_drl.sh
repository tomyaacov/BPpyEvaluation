...
#SBATCH --job-name run_multiple_trace_drl ### name of the job. replace my_job with your desired job name
#SBATCH --output run_multiple_trace_drl.out ### output log for running job - %J is the job number variable
...
~/.conda/envs/BPpyLiveness/bin/python pancake_single_trace_drl.py 200 25 1000 run
