...
#SBATCH --job-name check_gpu ### name of the job. replace my_job with your desired job name
#SBATCH --output check_gpu.out ### output log for running job - %J is the job number variable
...
#SBATCH --mem=4G ### total amount of RAM // 500
#SBATCH --ntasks=1
#SBATCH --gpus=1
...
~/.conda/envs/BPpyLiveness/bin/python check_gpu.py