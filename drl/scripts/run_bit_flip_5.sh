...
#SBATCH --job-name run_bit_flip_5 ### name of the job. replace my_job with your desired job name
#SBATCH --output run_bit_flip_5.out ### output log for running job - %J is the job number variable
...
~/.conda/envs/BPpyLiveness/bin/python bit_flipping.py 5 5 300000