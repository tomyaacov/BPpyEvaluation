...
#SBATCH --job-name run_single_trace_search3 ### name of the job. replace my_job with your desired job name
#SBATCH --output run_single_trace_search3.out ### output log for running job - %J is the job number variable
