...
#SBATCH --mem=10G ### total amount of RAM // 500
#SBATCH --ntasks=1
...
~/.conda/envs/bppy-py39/bin/python cinderella_dfs.py 5 30 2 5 1000
~/.conda/envs/bppy-py39/bin/python cinderella_dfs.py 5 40 2 5 1000
...
~/.conda/envs/bppy-py39/bin/python cinderella_dfs.py 5 30 2 6 1000
~/.conda/envs/bppy-py39/bin/python cinderella_dfs.py 5 40 2 6 1000
...
~/.conda/envs/bppy-py39/bin/python cinderella_dfs.py 5 30 2 7 1000
~/.conda/envs/bppy-py39/bin/python cinderella_dfs.py 5 40 2 7 1000
...
~/.conda/envs/bppy-py39/bin/python cinderella_dfs.py 5 30 2 8 1000
~/.conda/envs/bppy-py39/bin/python cinderella_dfs.py 5 40 2 8 1000