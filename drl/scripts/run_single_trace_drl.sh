...
#SBATCH --job-name run_single_trace_drl ### name of the job. replace my_job with your desired job name
#SBATCH --output run_single_trace_drl.out ### output log for running job - %J is the job number variable
